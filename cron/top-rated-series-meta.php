...
$movietitle = $conn->query('SELECT * FROM gettopratedseriesid');
...
$response = json_decode($response,true);
	...
	$stmt = $conn->prepare('INSERT INTO topratedseriesmeta (MovieId, MovieTitle, MovieRating, MovieRunTime, MoviePlot, MoviePoster, MovieReleaseDate, MovieCast, MovieLanguage) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
