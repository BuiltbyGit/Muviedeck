...
$movietitle = $conn->query('SELECT * FROM getpopularseriesid');
...
$response = json_decode($response,true);
	...
	$stmt = $conn->prepare('INSERT INTO popularseriesmeta (MovieId, MovieTitle, MovieRating, MovieRunTime, MoviePlot, MoviePoster, MovieReleaseDate, MovieCast, MovieLanguage) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
