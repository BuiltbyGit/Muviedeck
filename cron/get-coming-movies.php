...
$stmt = $conn->prepare('TRUNCATE TABLE getcomingmoviesid');
$stmt->execute();
...
curl_setopt_array($curl, [
	CURLOPT_URL => "https://imdb8.p.rapidapi.com/title/get-coming-soon-movies?homeCountry=US&purchaseCountry=US&currentCountry=US",
...
for ($i=0; $i < 50; $i++) { 
	...
	echo '<br/>';
	$stmt = $conn->prepare('INSERT INTO getcomingmoviesid (title) VALUES (?)');
