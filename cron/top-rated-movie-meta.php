...
$movietitle = $conn->query('SELECT * FROM gettopratedmoviesid');
...
$response = json_decode($response,true);
	...
	$stmt = $conn->prepare('INSERT INTO topratedmoviemeta (MovieId, MovieTitle, MovieRating, MovieRunTime, MoviePlot, MoviePoster, MovieReleaseDate, MovieCast, MovieLanguage) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)');
